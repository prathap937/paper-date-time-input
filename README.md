# paper-date-time-input [![Build Status](https://travis-ci.org/gazal-k/paper-date-time-input.svg?branch=master)](https://travis-ci.org/gazal-k/paper-date-time-input)
